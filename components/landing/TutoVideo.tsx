        ...
        <div className="grid grid-cols-2 h-screen">
            <div className="flex items-center">
                <div className="space-y-5">
                    <h1 className="text-7xl font-extrabold font-title">What is Enigmap ?</h1>
                    ...
                    <Button size="lg" className="bg-emerald-500 text-xl text-base-100 flex items-center group font-title tracking-wider">
                        <span>Play Now</span>
                ...
                <div className="stack w-full">
                    <div className="card shadow-md bg-primary text-primary-content">
                        <div className="overflow-hidden w-full rounded-2xl">
                            <iframe className='w-full h-[75dvh]'
                                src={`https://www.youtube.com/embed/6y9rMxzu-HY?si=A9XlYbVjFkqmy4Cn`}
