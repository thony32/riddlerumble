            ...
            <div className="w-[80%] xl:w-1/2 text-center space-y-8">
                ...
                <div className="space-y-5">
                    ...
                    <div className="w-full flex flex-col md:flex-row justify-between gap-5 md:gap-[30%]">
                        <div className="text-justify text-lg md:text-2xl xl:text-3xl max-xl:first-letter:text-3xl first-letter:text-5xl">
                    ...
                    <div className="flex justify-center">
                        {sessionPending ? (
                            ...
                            <Link href="/game">
                                <Button className="flex items-center gap-2 bg-blue-500 text-white tracking-wider font-title group" size="lg" onClick={() => setIsLoading(true)}>
                            ...
                            <div className="flex gap-5 items-center">
                                <Link href={urlsData?.googleUrl ?? ""}>
                                    <Button onClick={() => setIsLoading(true)} className="bg-blue-500 text-white" size="lg">
                                        {isLoading ? (
                                            <div className="flex justify-center">
                                                <span className="loading loading-dots loading-md"></span>
                                            </div>
                                            ...
                                            <>
                                                ...
                                                <svg className="w-7 fill-current group-hover:rotate-[360deg] duration-700" viewBox="0 0 24 24">
                                ...
                                <Button className="bg-sky-500 text-white" size="lg" onPress={onOpen}>
                                    <span className="text-xl">New account</span>
                                    <svg className="w-7 fill-current group-hover:scale-125 duration-100" viewBox="0 0 24 24">
                                        <path d="M20.283 10.356h-8.327v3.451h4.792c-.446 2.193-2.313 3.453-4.792 3.453a5.27 5.27 0 0 1-5.279-5.28 5.27 5.27 0 0 1 5.279-5.279c1.259 0 2.397.447 3.29 1.178l2.6-2.599c-1.584-1.381-3.615-2.233-5.89-2.233a8.908 8.908 0 0 0-8.934 8.934 8.907 8.907 0 0 0 8.934 8.934c4.467 0 8.529-3.249 8.529-8.934 0-.528-.081-1.097-.202-1.625z"></path>
                                    </svg>
                                </Button>
                                <Modal scrollBehavior="inside" backdrop="blur" isOpen={isOpen} onOpenChange={onOpenChange} isDismissable={false} isKeyboardDismissDisabled={true}>
                                    <ModalContent>
                                        {(onClose) => (
                                            <>
                                                ...
                                                <ModalBody>
                                                    <div className="grid grid-cols-2 gap-3">
                                                        <Input ref={pseudo_ref} type="text" variant="underlined" label="Pseudo" />
                                                        <Select
                                                            ref={nationality_ref}
                                                            variant="underlined"
                                                ...
                                                <ModalFooter>
                                                    ...
                                                    <Button color="primary" onClick={() => handleOAuth()}>
                                                        {isLoading ? (
                                                            <div className="flex justify-center">
                                                                <span className="loading loading-dots loading-md"></span>
                                                            </div>
