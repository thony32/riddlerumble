...
function Party() {
    ...
    const timerRender = ({ minutes, seconds, completed }: any) => {
        if (completed) {
        ...
        <div className="w-full h-screen py-6 relative overflow-hidden">
            <div className="grid grid-cols-12 gap-3">
                <div className="col-span-2 relative space-y-4">
                    <h1 className="text-xl">Find the place</h1>
                    <div>
                        <p>1- It is located in Europe.</p><p>2- The city won 6 champions league titles in the UEFA football club competition.</p><p>3- A place where Oktoberfest is a special party.</p><p>4- The favorite drink here is Beer</p>
                    </div>
                ...
                <div className="col-span-10 rounded-2xl relative">
                    ...
                    >
                        ...
                        >
                            <svg className="stroke-current w-10" viewBox="0 0 24 24" fill="none">
                                <path
                        ...
                        </Marker>
                        {
                            ...
                            <Marker
                                ...
                                anchor="bottom"
                            >
                                <svg className="stroke-current w-14" viewBox="0 0 24 24" fill="none">
                                    <path
