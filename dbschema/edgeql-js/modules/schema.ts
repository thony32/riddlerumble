...
export type $ObjectTypeλShape = $.typeutil.flatten<$SourceλShape & Omit<$ConsistencySubjectλShape, "<subject"> & $InheritingObjectλShape & Omit<$TypeλShape, "<target"> & $AnnotationSubjectλShape & {
  ...
  "<__type__[is Player_stats]": $.LinkDesc<_default.$Player_stats, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Room]": $.LinkDesc<_default.$Room, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Temp_room]": $.LinkDesc<_default.$Temp_room, $.Cardinality.Many, {}, false, false,  false, false>;
